# Hot Film Data Acquisition

The `hotfilm` acquisition program, written in C++, uses a [Labjack
T7](https://labjack.com/t7) to sample at 4 hotfilm AD channels at up to 4 KHz
and record the channels to disk in NIDAS dat archive format.

See [Install.md](../Install.md) to compile the `hotfilm` program.
