...
dumphotfilm="${hotfilmdir}/dump_hotfilm.py --netcdf ${hotfilm_output_spec} --log info"
calibrate="${hotfilmdir}/calibrate_hotfilm.py --log info --sonics ${sonics} --plot --calibrate --netcdf ${calibrated_output_spec} --images ${plot_output_spec}"
...
mkdir -p ${plot_output}
$dumphotfilm ${rawdata}/hotfilm_${date}_*.dat
$calibrate ${hotfilm_output}/hotfilm_${date}_*.nc
